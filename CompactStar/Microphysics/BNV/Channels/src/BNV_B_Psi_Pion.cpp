...
#include "CompactStar/Microphysics/BNV/Channels/BNV_B_Psi_Pion.hpp"
...
//==============================================================
// Constructor
MicroBNVCh::BNV_B_Psi_Pion::BNV_B_Psi_Pion(const int &i, const int &j)
...
//--------------------------------------------------------------
// Destructor
MicroBNVCh::BNV_B_Psi_Pion::~BNV_B_Psi_Pion() {}
//--------------------------------------------------------------
// Returns the time component of Sigma^0 in the baryon CM frame
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::get_Sig_0_CM(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
...
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::get_Sig_V_CM(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
...
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::get_q_V_CM(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	// -----------------------------
	//      Definitions
	// -----------------------------
	...
	q_v *= sqrt(pow(mu_pi, 4) + pow(1 - pow(mu_psi, 2) + 2 * x * sig + pow(sig, 2), 2) - 2 * pow(mu_pi, 2) * (1 + pow(mu_psi, 2) + 2 * x * sig + pow(sig, 2)));
	return q_v;
}
...
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::get_E_Psi_CM(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	// -----------------------------
	//      Definitions
	// -----------------------------
...
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::get_E_B_s(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
...
// Mistake fixed.
double MicroBNVCh::BNV_B_Psi_Pion::get_E_B_CM(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	// Wrong Answer:
	...
	//         + pow(pars.sig, 2) ) ;
	return pars.m_B * sqrt(1 + 2 * pars.x * pars.sig + pow(pars.sig, 2));
}

//--------------------------------------------------------------
// Returns the energy* of baryon (E_B^*) in the CM frame
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::get_E_B_s_CM(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
...
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::q_pstar_zero(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
...
//    evaluated in the CM frame
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::q_pstar_first(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
...
//    evaluated in the CM frame
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::qstar_pstar_zero(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	return (get_E_Psi_CM(pars) - get_Sig_0_CM(pars)) * get_E_B_s_CM(pars) - get_Sig_V_CM(pars) * get_Sig_V_CM(pars);
}
...
//     4-vector dot-product of (q*.p*)
//    evaluated in the CM frame
double MicroBNVCh::BNV_B_Psi_Pion::qstar_pstar_first(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	return get_q_V_CM(pars) * get_Sig_V_CM(pars);
}
...
//    evaluated in the CM frame
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::q_qstar_zero(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	return (get_E_Psi_CM(pars) - get_Sig_0_CM(pars)) * get_E_Psi_CM(pars) - get_q_V_CM(pars) * get_q_V_CM(pars);
}
...
//     4-vector dot-product of (q.q*)
//    evaluated in the CM frame
double MicroBNVCh::BNV_B_Psi_Pion::q_qstar_first(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	return get_q_V_CM(pars) * get_Sig_V_CM(pars);
}
...
//    evaluated in the CM frame
// Output verified on Nov 7, 2023
double MicroBNVCh::BNV_B_Psi_Pion::qstar_qstar_zero(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	return pow(get_E_Psi_CM(pars) - get_Sig_0_CM(pars), 2) - get_q_V_CM(pars) * get_q_V_CM(pars) - get_Sig_V_CM(pars) * get_Sig_V_CM(pars);
}
...
//     4-vector dot-product of (q*.q*)
//    evaluated in the CM frame
double MicroBNVCh::BNV_B_Psi_Pion::qstar_qstar_first(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
...
double MicroBNVCh::BNV_B_Psi_Pion::phase_W0_zero(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	// -----------------------------
	//      Definitions
	// -----------------------------
	...
	if (q_v * Sig_V > 1e-20)
	{
		val += (b_B * (b_B - c_B) * pow(m_B, 2) * log((pow(m_B, 2) - T - 2 * q_v * Sig_V) / (pow(m_B, 2) - T + 2 * q_v * Sig_V))) / (q_v * Sig_V);
	}
	else
	{
...
//   integrated over cos(theta)
double MicroBNVCh::BNV_B_Psi_Pion::phase_W0_first(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	// -----------------------------
	//      Definitions
	// -----------------------------
...
//   integrated over cos(theta)
double MicroBNVCh::BNV_B_Psi_Pion::phase_W1_zero(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	// -----------------------------
	//      Definitions
	// -----------------------------
...
//   integrated over cos(theta)
double MicroBNVCh::BNV_B_Psi_Pion::phase_W1_first(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	// -----------------------------
	//      Definitions
	// -----------------------------
...
//   integrated over cos(theta)
double MicroBNVCh::BNV_B_Psi_Pion::phase_W1_second(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	// -----------------------------
	//      Definitions
	// -----------------------------
...
//   integrated over cos(theta)
double MicroBNVCh::BNV_B_Psi_Pion::phase_W0W1_zero(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	// -----------------------------
	//      Definitions
	// -----------------------------
...
//   integrated over cos(theta)
double MicroBNVCh::BNV_B_Psi_Pion::phase_W0W1_first(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	// -----------------------------
	//      Definitions
	// -----------------------------
...
double MicroBNVCh::BNV_B_Psi_Pion::Amp_A(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
	...
	//  Adding W1 factors
	// ------------------------
	double W1_zero_factor = 2 * qstar_pstar_zero(pars) * q_qstar_zero(pars) - qstar_qstar_zero(pars) * q_pstar_zero(pars);
	// std::cout << "\t 1 A = " << A << "\n" ;

	double W1_first_factor = 2 * qstar_pstar_zero(pars) * q_qstar_first(pars) + 2 * qstar_pstar_first(pars) * q_qstar_zero(pars) - qstar_qstar_zero(pars) * q_pstar_first(pars) - qstar_qstar_first(pars) * q_pstar_zero(pars);
	// std::cout << "\t 2 A = " << A << "\n" ;

	double W1_second_factor = 2 * qstar_pstar_first(pars) * q_qstar_first(pars) - qstar_qstar_first(pars) * q_pstar_first(pars);
...
double MicroBNVCh::BNV_B_Psi_Pion::LoopIntegral(const double &xD, const double &xU, const double &xY)
{
...
double MicroBNVCh::BNV_B_Psi_Pion::Amplitude(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
...
double MicroBNVCh::BNV_B_Psi_Pion::CM_Decay_Rate(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
...
//--------------------------------------------------------------
// The baryon decay rate in the CM frame (in MeV)
double MicroBNVCh::BNV_B_Psi_Pion::NM_Decay_Rate(const MicroBNVCh::BNV_B_Psi_Pion::Params &pars)
{
...
double MicroBNVCh::BNV_B_Psi_Pion::PhaseSpace_Integral(const double &x_F)
{
	// selected_pars = pars ;
	...
	Zaki::Math::GSLFuncWrapper<BNV_B_Psi_Pion, double (MicroBNVCh::BNV_B_Psi_Pion::*)(const double &)>
		Fp(this, &MicroBNVCh::BNV_B_Psi_Pion::PhaseSpace_Integrand);
...
double MicroBNVCh::BNV_B_Psi_Pion::PhaseSpace_Integrand(const double &x)
{
	...
	n_dot_p *= pow(selected_pars.m_B, 3) * sqrt(x * x - 1) * x;
...
Zaki::Vector::DataSet MicroBNVCh::BNV_B_Psi_Pion::Rate_vs_Density(
	const double &m_psi,
	const Baryon &B,
...
Zaki::Vector::DataSet MicroBNVCh::BNV_B_Psi_Pion::Rate_vs_R(const double &m_psi,
															const Baryon &B,
															const bool &gen_plots)
{
