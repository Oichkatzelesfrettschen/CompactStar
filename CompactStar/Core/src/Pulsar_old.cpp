...
#include "CompactStar/Core/Pulsar_old.hpp"
...
double Pulsar::Get_DUrca_Neutrino_Rate(const double &in_radius) const
{
	...
	return 1.380649e-16 * 1e-39 * Get_DUrca_Neutrino_Emissivity(in_radius) / Get_T(in_radius);
}
...
Zaki::Vector::DataColumn Pulsar::Get_DUrca_Neutrino_Rate() const
{
	...
	// Change [erg K^-1 cm^-3 s^-1] to [ fm^-3 s^-1]
	return 1.380649e-16 * 1e-39 * Get_DUrca_Neutrino_Emissivity() / Get_T();
}
...
double Pulsar::Get_MUrca_Neutrino_Rate(const double &in_radius) const
{
	...
	// Change [erg K^-1 cm^-3 s^-1] to [ fm^-3 s^-1]
	return 1.380649e-16 * 1e-39 * Get_MUrca_Neutrino_Emissivity(in_radius) / Get_T(in_radius);
}
...
Zaki::Vector::DataColumn Pulsar::Get_MUrca_Neutrino_Rate() const
{
	...
	// Change [erg K^-1 cm^-3 s^-1] to [ fm^-3 s^-1]
	return 1.380649e-16 * 1e-39 * Get_MUrca_Neutrino_Emissivity() / Get_T();
}
...
{
	return Get_DUrca_Neutrino_Emissivity(in_radius) + Get_MUrca_Neutrino_Emissivity(in_radius);
}
...
{
	return Get_DUrca_Neutrino_Emissivity() + Get_MUrca_Neutrino_Emissivity();
}
...
double Pulsar::Get_Neutrino_Rate(const double &in_radius) const
{
	...
	// Change [erg K^-1 cm^-3 s^-1] to [ fm^-3 s^-1]
	return 1.380649e-16 * 1e-39 * Get_Neutrino_Emissivity(in_radius) / Get_T(in_radius);
}
...
Zaki::Vector::DataColumn Pulsar::Get_Neutrino_Rate() const
{
	...
	// Change [erg K^-1 cm^-3 s^-1] to [ fm^-3 s^-1]
	return 1.380649e-16 * 1e-39 * Get_Neutrino_Emissivity() / Get_T();
}
									  ...
									  const Zaki::String::Directory &in_dir) const
{
	...
	nu_emiss_plt.SemiLogYPlot(0, {{1, {{"ls", "--"}, {"label", "DUrca"}}}, {2, {{"ls", "--"}, {"label", "MUrca"}}}, {3, {{"ls", "-."}, {"label", "Tot"}}}}, in_dir + file, name);
}
								...
								const Zaki::String::Directory &in_dir) const
{
	...
	nu_rate_plt.SemiLogYPlot(0, {{1, {{"ls", "--"}, {"label", "DUrca"}}}, {2, {{"ls", "--"}, {"label", "MUrca"}}}, {3, {{"ls", "-."}, {"label", "Tot"}}}}, in_dir + file, name);
}
