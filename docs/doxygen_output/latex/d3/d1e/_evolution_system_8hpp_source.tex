...
\DoxyCodeLine{197     \textcolor{keywordtype}{void} ValidateContext() \textcolor{keyword}{const};}
\DoxyCodeLine{198 }
\DoxyCodeLine{199     \mbox{\hyperlink{struct_compact_star_1_1_physics_1_1_evolution_1_1_driver_context}{DriverContext}} m\_ctx;             }
\DoxyCodeLine{200     \mbox{\hyperlink{class_compact_star_1_1_physics_1_1_evolution_1_1_state_vector}{StateVector}} \&m\_state;              }
\DoxyCodeLine{201     \mbox{\hyperlink{class_compact_star_1_1_physics_1_1_evolution_1_1_r_h_s_accumulator}{RHSAccumulator}} \&m\_rhs;              }
\DoxyCodeLine{202     \textcolor{keyword}{const} \mbox{\hyperlink{class_compact_star_1_1_physics_1_1_evolution_1_1_state_layout}{StateLayout}} \&m\_layout;   }
\DoxyCodeLine{203     std::vector<DriverPtr> m\_drivers; }
\DoxyCodeLine{204 }
\DoxyCodeLine{212     std::vector<ObserverPtr> m\_observers;}
\DoxyCodeLine{213 \};}
\DoxyCodeLine{214 }
\DoxyCodeLine{215 \} \textcolor{comment}{// namespace Evolution}}
\DoxyCodeLine{216 \} \textcolor{comment}{// namespace Physics}}
\DoxyCodeLine{217 \} \textcolor{comment}{// namespace CompactStar}}
\DoxyCodeLine{218 }
\DoxyCodeLine{219 \textcolor{preprocessor}{\#endif }\textcolor{comment}{/* CompactStar\_Physics\_Evolution\_EvolutionSystem\_H */}\textcolor{preprocessor}{}}
