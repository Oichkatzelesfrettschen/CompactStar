...
\DoxyCodeLine{84 }
\DoxyCodeLine{94     \textcolor{keywordtype}{void} \mbox{\hyperlink{class_compact_star_1_1_physics_1_1_evolution_1_1_r_h_s_accumulator_a63e5b050de3c687e57d7abca297673ad}{Configure}}(\mbox{\hyperlink{_tags_8hpp_af14f5554b0d9be50c5ea718733bc424b}{Physics::State::StateTag}} tag, std::size\_t size)}
\DoxyCodeLine{95     \{}
...
\DoxyCodeLine{99     \}}
\DoxyCodeLine{100 }
\DoxyCodeLine{104     [[nodiscard]] \textcolor{keywordtype}{bool} \mbox{\hyperlink{class_compact_star_1_1_physics_1_1_evolution_1_1_r_h_s_accumulator_afc832703bdeed29d4be9438845b0b829}{IsConfigured}}(\mbox{\hyperlink{_tags_8hpp_af14f5554b0d9be50c5ea718733bc424b}{Physics::State::StateTag}} tag)\textcolor{keyword}{ const}}
...
\DoxyCodeLine{129                                      std::string(Physics::State::ToString(tag)) +}
...
\DoxyCodeLine{162 }
\DoxyCodeLine{171     [[nodiscard]] \textcolor{keyword}{const} std::vector<double> \&\mbox{\hyperlink{class_compact_star_1_1_physics_1_1_evolution_1_1_r_h_s_accumulator_ab850248c73733517b68d4a82ddd25db6}{Block}}(\mbox{\hyperlink{_tags_8hpp_af14f5554b0d9be50c5ea718733bc424b}{Physics::State::StateTag}} tag)\textcolor{keyword}{ const}}
...
\DoxyCodeLine{177                                      std::string(Physics::State::ToString(tag)) +}
\DoxyCodeLine{178                                      \textcolor{stringliteral}{"{}' not configured."{}});}
\DoxyCodeLine{179         \}}
\DoxyCodeLine{180         \textcolor{keywordflow}{return} block.data;}
\DoxyCodeLine{181     \}}
\DoxyCodeLine{182 }
\DoxyCodeLine{191     std::vector<double> \&\mbox{\hyperlink{class_compact_star_1_1_physics_1_1_evolution_1_1_r_h_s_accumulator_ad962d2339286b8dda25323c42780666a}{Block}}(\mbox{\hyperlink{_tags_8hpp_af14f5554b0d9be50c5ea718733bc424b}{Physics::State::StateTag}} tag)}
\DoxyCodeLine{192     \{}
...
\DoxyCodeLine{197                                      std::string(Physics::State::ToString(tag)) +}
...
\DoxyCodeLine{205     \textcolor{comment}{//  Internal structures / helpers}}
\DoxyCodeLine{206     \textcolor{comment}{// -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{207 }
\DoxyCodeLine{208     \textcolor{comment}{// Renamed to avoid collision with Block(...) member functions.}}
\DoxyCodeLine{209     \textcolor{keyword}{struct }BlockStorage}
\DoxyCodeLine{210     \{}
\DoxyCodeLine{211         std::vector<double> data;}
\DoxyCodeLine{212         \textcolor{keywordtype}{bool} configured = \textcolor{keyword}{false};}
\DoxyCodeLine{213     \};}
\DoxyCodeLine{214 }
\DoxyCodeLine{216     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} std::size\_t NumTags =}
\DoxyCodeLine{217         \textcolor{keyword}{static\_cast<}std::size\_t\textcolor{keyword}{>}(Physics::State::StateTag::Custom) + 1;}
\DoxyCodeLine{218 }
\DoxyCodeLine{220     \textcolor{keyword}{static} \textcolor{keyword}{constexpr} std::size\_t Index(\mbox{\hyperlink{_tags_8hpp_af14f5554b0d9be50c5ea718733bc424b}{Physics::State::StateTag}} tag)}
\DoxyCodeLine{221     \{}
\DoxyCodeLine{222         \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}std::size\_t\textcolor{keyword}{>}(tag);}
\DoxyCodeLine{223     \}}
\DoxyCodeLine{224 }
\DoxyCodeLine{226     std::array<BlockStorage, NumTags> blocks\_;}
\DoxyCodeLine{227 \};}
\DoxyCodeLine{228 }
\DoxyCodeLine{229 \} \textcolor{comment}{// namespace CompactStar::Physics::Evolution}}
\DoxyCodeLine{230 }
\DoxyCodeLine{231 \textcolor{preprocessor}{\#endif }\textcolor{comment}{/* CompactStar\_Physics\_Evolution\_RHSAccumulator\_H */}\textcolor{preprocessor}{}}
